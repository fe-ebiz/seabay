    ...
    <div class="sub room_detail">
        <div id="slider_room" class="slider_container room">
            <div data-u="slides" class="slides">
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/royalsuite/room_01.jpg" alt="01" /></div>
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/royalsuite/room_02.jpg" alt="02" /></div>
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/royalsuite/room_03.jpg" alt="03" /></div>
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/royalsuite/room_02.jpg" alt="04" /></div>
            </div>
            ...
            <div class="detail box_center">
                ...
                <div class="box_left">
                    ...
                    <div class="description">
                        ...
                        <div class="cont">
                            <ul class="c_list">
                                <li>객실 크기 : 50㎡ (15.2평)</li>
                                <li>침대 타입 : 더블 + 싱글 + 싱글</li>
