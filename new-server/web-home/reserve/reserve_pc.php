 ...
 <!-- 예약페이지 가져오기 , 아래 부분은 개발단에서 작업(아래는 예시)-->
        <div id="contents">
            ...
            <div id="reservation_go">                
				<?php
					...
					include(INC_DIR."/www/web-home/reserve/inc/rnew_choice.php");
				?>
            </div>
            ...
            <div id="infom_box" class="title">
                <!----상품소개---->
                <span class="slogan_icon" id="room_info"><img src="//img.go.co.kr/slogan_tit_01.jpg"></span>
		...
		if($_COOKIE["ocean_ad"] == "Y") {
			...
			";
                ...
                <!--contents_mn테이블 끝-->
                <!----갤러리---->
                <span class="slogan_icon"><img src="//img.go.co.kr/slogan_tit_02.jpg"></span>
                ...
                <span class="slogan_icon"><img src="//img.go.co.kr/slogan_tit_04.jpg"></span>
                <div id="info_box4">
                ...
                <!--contents_mn테이블 끝-->
                <!----축제/관광지/맛집----->
                <span class="slogan_icon"><img src="//img.go.co.kr/slogan_tit_05.jpg"></span>
                <div id="info_box5">
					<?php
