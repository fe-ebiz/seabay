    ...
    <div class="sub room_detail">
        <div id="slider_room" class="slider_container room">
            <div data-u="slides" class="slides">
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/dx_quadkids/room_01.jpg" alt="01" /></div>
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/dx_quadkids/room_02.jpg" alt="02" /></div>
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/dx_quadkids/room_03.jpg" alt="03" /></div>
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.seabay.co.kr/svc/img/rooms/_new/dx_quadkids/room_02.jpg" alt="04" /></div>
            </div>
                    ...
                    <div class="description">
                        ...
                        <div class="cont">
                            <ul class="c_list">
                                ...
                                <li>2층 침대는 계단, 기둥 등의 구성으로 인해 키 170cm 이하,<br>몸무게 60kg 이하의 고객님이 편히 이용하실 수 있습니다.</li>
                            </ul>
                        </div>
                    </div>
