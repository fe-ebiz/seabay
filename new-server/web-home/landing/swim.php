    ...
    <div class="swim-wrap">
        ...
        <section class="main-contents">
            <div class="contents-intro">
                <img src="http://img.seabay.co.kr/svc/img/landing/sebeaySwim_20200721/intro/land_swim01.jpg" alt="씨베이 콘텐츠">
            </div>
            <div class="contents-guid">
                <img src="http://img.seabay.co.kr/svc/img/landing/sebeaySwim_20200721/intro/land_swim02.jpg" alt="씨베이 콘텐츠">
            </div>
        </section>
        <!--//콘텐츠-->
